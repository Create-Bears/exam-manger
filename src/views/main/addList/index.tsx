    ...
    showConfirm=()=> {
        ...
        confirm({
            ...
            onOk (){
                ...
                let {questions_type_id,questions_stem,subject_id,exam_id,user_id,questions_answer,title} = that.state;
        ...
        return (
            <div>
                ...
                <div className="for-content">
                    <Editor value={questions_stem} onChange={this.handChangeStem}></Editor>
                </div>
                <div>
                    <div style={{ fontSize: '13px' }}>
                        ...
                        <Select
                            defaultValue="周考1"
                            style={{ width: 200 }}
                            onChange={(value: any) => this.handSelect({ value, type: 'exam_id' })}>
                            <OptGroup label="">
                    ...
                    <div style={{ fontSize: '13px' }}>
                        ...
                        <Select
                            ...
                            style={{ width: 200 }}
                            onChange={(value: any) => this.handSelect({ value, type: 'subject_id' })}
                        >
                            <OptGroup label="">
                    ...
                    <div style={{ fontSize: '13px' }}>
                        ...
                        <Select defaultValue="简答题" style={{ width: 200 }} onChange={(value: any) => this.handSelect({ value, type: 'questions_type_id' })}>
                            <OptGroup label="">
                    ...
                    <div className="for-content">
                        <Editor value={questions_answer} onChange={this.handChangeAnswer}></Editor>
                    </div>
