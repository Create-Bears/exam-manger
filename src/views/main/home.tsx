            ...
            <Layout>
                ...
                >
                    ...
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['4']}>
                      <SubMenu
                          ...
                          <Menu.Item key="1"><NavLink to="/home/addlist">添加试题</NavLink></Menu.Item>
                          <Menu.Item key="2"><NavLink to="/home/textQuestion">试题分类</NavLink></Menu.Item>
                          <Menu.Item key="3"><NavLink to="/home/checkTextQuestion">查看试题</NavLink></Menu.Item>
                      </SubMenu>
                      <SubMenu
                    key="sub2"
                    title={
                ...
                <Layout>
                    ...
                    <Content style={{ margin: '24px 16px 0' }}>
                        <div style={{ padding: 24, background: '#ccc', minHeight: 360 }}>{this.props.children}</div>
                    </Content>
                </Layout>
            </Layout>
        )
